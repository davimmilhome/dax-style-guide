...
Por conta dessa conjuntura, é comum que o profssional técnico de Business Intellingece (BI), especialmente aqueles que trabalham em consultoria, herdem projetos contruídos de forma "peculiar", onde a manuteção se torna custosa e, em alguns casos, inviável. Além disso, mesmo que o projeto esteja bem construido, profissionais diferentes têm formas diferentes de trabalhar e, por conta disso, é possível acabar com um projeto que não segue padrão algum.
